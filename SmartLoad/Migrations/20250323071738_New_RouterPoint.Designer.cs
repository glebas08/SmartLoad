...
namespace SmartLoad.Migrations
{
    ...
    [Migration("20250323071738_New_RouterPoint")]
    partial class New_RouterPoint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartLoad.Models.Order", b =>
                {
                    ...
                    b.HasOne("SmartLoad.Models.RoutePoint", null)
                        .WithMany("Orders")
                        .HasForeignKey("RoutePointId1");
